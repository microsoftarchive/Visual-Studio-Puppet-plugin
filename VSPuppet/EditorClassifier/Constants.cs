...
namespace EditorClassifier
{
    public static class Constants
    {
        ...
        public const string TextDisplayName = "Puppet Text";

        public const string OperatorName = "puppet.operator";
        public const string OperatorDisplayName = "Puppet Operator";

        public const string DelimiterName = "puppet.delimiter";
        ...
        public const string RegexName = "puppet.regex";
        public const string RegexDisplayName = "Puppet Regex";

        public const string ErrorName = "puppet.error";
        public const string ErrorDisplayName = "Puppet Error";
    }
}
