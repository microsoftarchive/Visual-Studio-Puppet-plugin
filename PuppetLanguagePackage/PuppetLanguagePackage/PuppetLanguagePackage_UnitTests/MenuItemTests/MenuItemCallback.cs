...
using Microsoft.PuppetLanguagePackage;

namespace PuppetLanguagePackage_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new PuppetLanguagePackagePackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Microsoft.PuppetLanguagePackage.GuidList.guidPuppetLanguagePackageCmdSet, (int)Microsoft.PuppetLanguagePackage.PkgCmdIDList.cmdidMyCommand);
