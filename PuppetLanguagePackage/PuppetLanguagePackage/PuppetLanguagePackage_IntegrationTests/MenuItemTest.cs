...
namespace PuppetLanguagePackage_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Microsoft.PuppetLanguagePackage.GuidList.guidPuppetLanguagePackageCmdSet, (int)Microsoft.PuppetLanguagePackage.PkgCmdIDList.cmdidMyCommand);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "PuppetLanguagePackage", "Microsoft.PuppetLanguagePackage.PuppetLanguagePackagePackage");
